# Koyana Sahu — Professional Business Analytics Portfolio
...
- **Consulting Dark & Cream Aesthetic**: Tailored executive design with precision palette `#0A0A0A`, `#F8F0D0`, `#F8D858`, and `#484038`.
...
│
├── assets/
│   ├── images/                 # Profile images & visual artifacts
│   ├── certificates/           # Certificate PDFs and images
│   ├── resume/                 # Resume PDF files
│   └── icons/                  # Custom iconography (if needed)
│
