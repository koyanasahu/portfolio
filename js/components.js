        ...
        <div class="container">
          ...
          <div class="intern-projects-header-wrap">
            ...
            <div class="intern-projects-header-actions">
              <a href="${data.personal.github || 'https://github.com/koyanasahu'}" target="_blank" rel="noopener noreferrer" class="intern-header-icon-btn" aria-label="View GitHub Repository" title="GitHub Repository">
                ${Icons.github}
              </a>
            </div>
          </div>
